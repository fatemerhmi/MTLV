...
tokenizer = BertTokenizerFast.from_pretrained(".../model_weights/bert-base-uncased/bert-base-uncased")


model = BertForMaskedLM.from_pretrained('.../model_weights/bert-base-uncased/bert-base-uncased')
