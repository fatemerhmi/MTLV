...
labels_dict={
    ...
    'employee dispute and strike': "a complaint, argument, or disagreement between employees and their employer or between two or more employees. Strike is a work stoppage, caused by the mass refusal of employees to work.",
    ...
    'business outlook and projections': "Business Outlook Surveys are qualitative surveys to track the current economic situation and to forecast short-term trends. Financial projections use existing or estimated financial data to forecast your business's future income and expenses.",
